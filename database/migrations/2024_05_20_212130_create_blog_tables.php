...
return new class() extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('posts', function (Blueprint $table) {
            ...
            $table->foreignUuid(config('filamentblog.user.foreign_key'))->constrained()
                ->cascadeOnDelete();
            $table->timestamps();
        });
        ...
        Schema::create('category_post', function (Blueprint $table) {
            $table->id();
            $table->foreignIdFor(Firefly\FilamentBlog\Models\Post::class)->constrained()
                ->cascadeOnDelete();
            $table->foreignIdFor(Firefly\FilamentBlog\Models\Category::class)->constrained()
                ->cascadeOnDelete();
            $table->timestamps();
        });
        ...
        Schema::create('post_tag', function (Blueprint $table) {
            ...
            $table->foreignIdFor(Firefly\FilamentBlog\Models\Post::class)->constrained()
                ->cascadeOnDelete();
            $table->foreignIdFor(Firefly\FilamentBlog\Models\Tag::class)->constrained()
                ->cascadeOnDelete();
            $table->timestamps();
        });

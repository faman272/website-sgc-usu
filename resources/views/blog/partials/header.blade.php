...
<header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
        <a href="/" class="logo"><img src="{{ url('logo-sgc.png') }}" alt="Logo"></a>
        <nav id="navbar" class="navbar">
            <ul class="nav-item">
                        ...
                        <li class="dropdown"><a href="#"><span>Kepengurusan</span> <i
                            ...
                            <ul>
                                @foreach ($divisis as $divisi)
                                    <li><a class="divisi-nama" href="{{ route('divisi.show', $divisi->slug) }}">{{ $divisi->slug }}</a></li>
                                @endforeach
                ...
                <li><a class="nav-link {{ Request::is('blog') ? 'active' : '' }}" href="/blogs">Blog</a></li>
                <li><a class="nav-link {{ Request::is('toko') ? 'active' : '' }}" href="/shop">Shop</a></li>
